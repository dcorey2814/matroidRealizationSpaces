...
cursor=Polymake.Polydb.find(collection, Dict("RANK" => 3,"SIMPLE"=>true,"N_ELEMENTS"=>12), opts=Dict("skip"=>16000001, "limit"=>20000000));

n3C12 = collect(powerset(1:12, 3, 3));
n3C12 = sort(n3C12, by =  x-> reverse(x));

io = open("matroids_d3n12/d3n12_3lines.5.dat", "w")
...
#    if (i%100000 == 0)
#        close(io)
#        global io = open("matroids_d3n12/d3n12_3lines.5.dat", "a")
#        println(i)
#    end
