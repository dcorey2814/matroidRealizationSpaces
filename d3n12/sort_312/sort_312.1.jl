...
d3n12_3_lines_1 = vec(readlines("matroids_d3n12/d3n12_3lines.1.dat"));
...
#for z in 1:200
for z in 1:length(d3n12_3_lines_1)
    
    Mzstr = d3n12_3_lines_1[z]
    ...
    if I[1] == [0] #reduces to 0
        ...
        open("matroids_d3n12/sorting1/zero_ideal.dat", "a")do file
    ...
    elseif (1 in I[1] || -1 in I[1] || I == "Not Realizable 0 in Semigroup")
     #println(z, " not_realizable")   
        ...
        open("matroids_d3n12/sorting1/not_realizable.dat", "a")do file
        write(file, String(Mzstr),"\n")
        end
        continue
    ...
    elseif int_gens(I[1])
        ...
        open("matroids_d3n12/sorting1/int_generator.dat", "a")do file
        write(file, String(Mzstr),"\n")
        end
        continue
    ...
    elseif length(I[1]) == 2
        ...
        if (length(vars(I[1][2])) == 1 && degree(I[1][2],vars(I[1][2])[1]) >=2)
            ...
            open("matroids_d3n12/sorting1/simplified_principle_reducible.dat", "a")do file
            write(file, String(Mzstr),"\n")
            end
            continue
            ...
            open("matroids_d3n12/sorting1/simplified_principle_n_reducible.dat", "a")do file
            write(file, String(Mzstr),"\n")
            end
            continue
    ...
    elseif length(I[1])>2
        ...
        open("matroids_d3n12/sorting1/simplified_not_principle.dat", "a")do file
        write(file, String(Mzstr),"\n")
        end
        continue
    else 
        #println(z, " net")
        #push!(net,z)
        open("matroids_d3n12/sorting1/net.dat", "a")do file
        write(file, String(Mzstr),"\n")
        end
        continue
    end
