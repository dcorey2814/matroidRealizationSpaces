...
d3n12_3_lines = vec(readlines(joinpath(currentDir, "d3n12/3lines_d3n12.3.2.dat")));
...
sortingDir = joinpath(currentDir, "d3n12/sorting_3_2") # makes the directory "sorting", if not already created.
