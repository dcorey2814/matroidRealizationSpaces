...
d3n12 = vec(readlines(joinpath(currentDir, "d3n12/3lines_d3n12.6.1.dat")));
...
sortingDir = joinpath(currentDir, "d3n12/sorting_6_1") # makes the directory "sorting", if not already created.
