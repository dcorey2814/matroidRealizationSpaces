...
d3n12 = vec(readlines(joinpath(currentDir, "d3n12/3lines_d3n12.4.3.dat")));
...
sortingDir = joinpath(currentDir, "d3n12/sorting_4_3") # makes the directory "sorting", if not already created.
