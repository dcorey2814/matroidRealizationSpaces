...
d3n12_3_lines = vec(readlines(joinpath(currentDir, "d3n12/3lines_d3n12.3.1.dat")));
...
sortingDir = joinpath(currentDir, "d3n12/sorting_3_1") # makes the directory "sorting", if not already created.
...
for z in 63068:length(d3n12_3_lines)
#for z in 1:length(d3n12_3_lines)

    Mzstr = d3n12_3_lines[z]
