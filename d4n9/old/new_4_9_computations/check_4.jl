...
for z in 49012:length(d4n9)
    ...
    Mz = matroid_from_revlex_basis_encoding(d4n9[z], 4, 9)
     ...
     if !is_connected(Mz)
        ...
        open("disconnected_4_9/disconnected_4_9_4.dat", "a") do file
            write(file,d4n9[z],"\n")
          end
    else
    ...
    if length(C) == 0
        println("weird")
         ...
         open("weird_4_9/4_planes_weird_4_9_4.dat", "a") do file
            write(file,d4n9[z],"\n")
          end
    ...
    MR = new_matroid_realization_space(Mz,A;F = QQ,saturate = true) #compute realization space
        ...
        if !MR.representable#check realizability
            ...
            open("not_realizable_4_9/not_realizable_4_9_4.dat", "a") do file
                write(file,data,"\n")
            end
           
        else  println("reducing ring")
...
println("classify")
            if iszero(I)#check if ideal reduces to zero wrt to this reference circuit
                ...
                println("zero ideal")
                    open("zero_ideal_4_9/zero_4_9_4.dat", "a") do file
                    write(file,data,"\n")
            ...
            elseif length(Igens) == 1 #check if principle
                    ...
                    if length(ideal_vars(Igens)) == 1#check if univariate
                        ...
                        if isone(J)#smooth
                          ...
                          open("princ_univariate_4_9/smooth_4.dat", "a") do file
                             write(file,data,"\n")
                         end 
                    else #singular

                        println("princ univariate singular")
                        open("princ_univariate_4_9/singular_4.dat", "a") do file
                          write(file,data,"\n")
                        end
                    end
                    ...
                    if isone(J)#smooth
                          ...
                          open("princ_multivariate_4_9/smooth_4.dat", "a") do file
                             write(file,data,"\n")
                         end 
                    else #singular

                        println("princ multivariate singular")
                        open("princ_multivariate_4_9/singular_4.dat", "a") do file
                          write(file,data,"\n")
                        end
         ...
         elseif length(Igens) > 1 #check if multiple generators
                    ...
                    if length(ideal_vars(Igens)) == 1#check if univariate
                      ...
                      if isone(J)#smooth
                              ...
                              open("not_princ_univariate_4_9/smooth_4.dat", "a") do file
                                 write(file,data,"\n")
                             end 
                      else #singular
    
                            println("not princ univariate singular")
                            open("not_princ_univariate_4_9/singular_4.dat", "a") do file
                              write(file,data,"\n")
                            end
                        ...
                        if isone(J)#smooth
                              ...
                              open("not_princ_multivariate_4_9/smooth_4.dat", "a") do file
                                 write(file,data,"\n")
                             end 
                        else #singular

                            println("not multivariate singular")
                            open("not_princ_multivariate_4_9/singular_4.dat", "a") do file
                              write(file,data,"\n")
                            end
