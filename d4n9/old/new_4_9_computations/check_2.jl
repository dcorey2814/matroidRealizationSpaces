...
for z in 27033:30000
 ...
 println("check connectivity")
     if !is_connected(Mz)
        ...
        open("disconnected_4_9/disconnected_4_9_2.dat", "a") do file
            write(file,d4n9[z],"\n")
          end
    else
    ...
    if length(C) == 0
        println("no ref circ")
         ...
         open("no_ref_circ_4_9/no_ref_circ_4_9_2.dat", "a") do file
            write(file,d4n9[z],"\n")
          end
...
println("classify")
            if iszero(I)#check if ideal reduces to zero wrt to this reference circuit
                ...
                println("zero ideal")
                    open("zero_ideal_4_9/zero_4_9_2.dat", "a") do file
                    write(file,data,"\n")
         ...
         elseif length(Igens) > 1 #check if multiple generators
                    ...
                    if length(ideal_vars(Igens)) == 1#check if univariate
                      ...
                      if isone(J)#smooth
                              ...
                              open("not_princ_univariate_4_9/smooth_2.dat", "a") do file
                                 write(file,data,"\n")
                             end 
                      else #singular
    
                            println("not princ univariate singular")
                            open("not_princ_univariate_4_9/singular_2.dat", "a") do file
                              write(file,data,"\n")
                            end
                        ...
                        if isone(J)#smooth
                              ...
                              open("not_princ_multivariate_4_9/smooth_2.dat", "a") do file
                                 write(file,data,"\n")
                             end 
                        else #singular

                            println("not multivariate singular")
                            open("not_princ_multivariate_4_9/singular_2.dat", "a") do file
                              write(file,data,"\n")
                            end
