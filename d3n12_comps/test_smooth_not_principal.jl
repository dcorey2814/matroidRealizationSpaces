...
file_2_sm = open(filename_np_2vars_smooth, "w")
file_3_sm = open(filename_np_3vars_smooth, "w")

file_3 = open(filename_np_3vars_remaining, "w")
file_4 = open(filename_np_4vars_remaining, "w")
