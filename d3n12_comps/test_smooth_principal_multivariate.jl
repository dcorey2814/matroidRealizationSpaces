...
file_pm_smooth = open(joinpath(singularDir, string("principal_2var_smooth.",ARGS[2],".dat")), "w")

filename_pm_singular = joinpath(singularDir, string("principal_2var_singular.",ARGS[2],".dat"))
filename_nonrealizable = joinpath(currentDir, "d3n12",  string("new_nonrealizable_2var.",ARGS[2],".dat"))
filename_skipped_geq3vars = joinpath(singularDir, string("principal_geq3vars.",ARGS[2],".dat"))
