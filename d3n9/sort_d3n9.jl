...
d3n9_3_lines = vec(readlines(joinpath(currentDir, "d3n9/3lines_d3n9.dat")));
...
sortingDir = joinpath(currentDir, "d3n9/sorting") # makes the directory "sorting", if not already created.
...
for z in 1:length(d3n9_3_lines)

    Mzstr = d3n9_3_lines[z]
    Mz = matroid_from_revlex_basis_encoding(Mzstr, 3, 9)
